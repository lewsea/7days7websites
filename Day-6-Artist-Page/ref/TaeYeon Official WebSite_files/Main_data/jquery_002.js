...
jQuery.fn.sb = function(o) {
  ...
  $(this).each(function() {
    ...
    function loadSB() {
      ...
      $("body").append($sb);
      $display = $("<a href='#' class='display'><span class='value'>" + $orig.val() + "</span> <span class='text'>" + o.optionFormat.call($orig.find("option:selected")[0], 0, 0) + "</span>" + o.arrowMarkup + "</a>");
      $sb.append($display);
    ...
    function positionSB() {
      ...
      var bottomSpace = $(window).scrollTop() + $(window).height() - $display.offset().top - $display.outerHeight() - o.extraHeight;
